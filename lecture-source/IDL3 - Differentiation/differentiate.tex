...
\begin{itemize}
	...
	\end{align*}
	\item<+-> So, the Jacobian tells us the first-order output change produced by a small input perturbation.
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\end{itemize}
	\item<+-> Next week, we'll see how forward- and reverse-mode automatic differentiation compute these products through an arbitrary program.
\end{itemize}
\end{frame}
