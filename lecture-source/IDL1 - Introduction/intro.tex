...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Note: We are refreshing some material from last year's module, but the website may have old links.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item After each block of labs you will have to do a follow-up problem-sheet exercise that will be marked.
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{tabular}{ l l l }
     ...
     Lab 8  & 25-Nov & Recurrent Networks, Sequence Prediction and Embeddings \\
	\end{tabular}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Lab work $40\%$ - Handins in weeks 5 (23rd Oct), 9 (20th Nov), 10 (27th Nov), 12 (11th Dec)
		\item Final exam $60\%$
	\end{itemize}
\end{frame}
