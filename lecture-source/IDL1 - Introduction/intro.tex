...
\title[AICE3002 / AICE6001]{AICE3002 Introduction to Deep Learning \\ AICE6001 Introduction to Deep Learning (MSc)}
...
\begin{frame}
\frametitle{What does Deep Learning (and Differentiable Programming) give us?}
...
Deep Learning and Differentiable Programming give us the ability to computationally solve problems without needing to handcraft the solution or engineer the features. As long as we have data we can build and train models to make predictions.


\begin{frame}
\frametitle{Machine Learning in a Nutshell}
...
\vspace{3mm} \\ \pause
Loss function & $\mathcal{L} = \sum^N_{n=1} \|\bm{y}_n - f (\bm{x}_n; \bm{\theta})\|^2_2$
\vspace{3mm} \\ \pause
Parameter Estimation & $\displaystyle \bm{\hat \theta} = \argmin_{\bm{\theta}} \mathcal{L}$
\vspace{3mm} \\ \pause
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item<+-> Think critically about why certain approaches were designed in the way they were.
...
\begin{frame}
	...
	\begin{itemize}
		\item<+-> Lectures and seminars (3 most weeks)
		\begin{itemize}
			\item This is a new module; we're utilising some material from our older module, but also adding/expanding and changing. Expect the moodle pages to change!
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Not recorded, but contents examinable
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item<+-> Labs (1x 2 hour session per week for 8 weeks + one additional optional help / catchup session)
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item You will need to utilise GPU-compute for the later labs (we provide Google Colab links so you can use NVidia GPUs in the cloud).
			\end{itemize}
			\item Labs are in-person (AICE lab in B32) with a team of PhD student demonstrators \& both of us.
			\item Please ask lots of questions and use this time to get help on the labs.
			\item After each block of labs you will have to do a follow-up "Lab Investigation" that will be marked.
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	\center
	\includegraphics[scale=0.2]{planner.pdf}
\end{frame}

\begin{frame}
	\frametitle{What will we cover in the module?}

	AICE3002: \url{https://moodle.ecs.soton.ac.uk/course/view.php?id=1031} \\[1em]
	AICE6001: \url{https://moodle.ecs.soton.ac.uk/course/view.php?id=1034}
\end{frame}
...
\begin{frame}
	...
	\begin{tabular}{ l l l }
		 ...
		 Lab 1  & 30-Sep & Tensor programming with PyTorch \\
		 Lab 2  & 07-Oct & Automatic Differentiation \\
		 Lab 3  & 14-Oct & Optimisation \\
		 Lab 4  & 21-Oct & Linear Models \\
 		 Lab 5  & 28-Oct & NNs with PyTorch and Torchbearer \\
 		        & 04-Nov & (Catch up / help) \\
 		 Lab 6  & 11-Nov & CNNs with PyTorch and Torchbearer \\
     Lab 7  & 18-Nov & Using pretrained models and transfer learning \\
     Lab 8  & 25-Nov & Recurrent Networks, Sequence Prediction \& Embeddings \\
	\end{tabular}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Lab Investigations $40\%$
		\item Final exam $60\%$
	\end{itemize}
\end{frame}

\begin{frame}
	\frametitle{Lab Investigations}

	Note these are the same for both AICE3002 and AICE6001

	\begin{center}
	\begin{tabular}{ l l l l }
		 Investigation & Submission Date & Labs covered \\ \hline
		 1 - Gradients and Matrix Completion & 23rd Oct, 4PM & 1 and 2 \\
		 2 - Optimisation and Wide Networks & 20th Nov, 4PM & 3, 4 and 5 \\
		 3 - Convolutions and Transfer & 27th Nov, 4PM & 6 and 7 \\
		 4 -Transforming Sequences & 11th Dec, 4PM & 8 \\
	\end{tabular}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item 2 hour duration, in-person, written.
		\item Common Section A questions.
		\item Different Section B questions for AICE3002 and AICE6001.
		\item More details to follow later in the semester, including a cut-down sample paper with representative questions
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
	\item<+-> You have have taken Foundations of Machine Learning, or are currently taking it.
...
\begin{frame}
	\frametitle{What comes after this module?}
	\begin{itemize}
		\item AICE6002: Deep Learning Research
		\begin{itemize}
			\item taught by both of us
			\item focus on translating the fundamentals you learn in this module to cutting edge research
			\item plus lectures on advanced architectures, generative models, etc
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Homework: Register for access to SWARM - \url{https://tinyurl.com/ecs-swarm}
		\item Any questions?
	\end{itemize}
\end{frame}
