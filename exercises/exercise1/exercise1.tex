...
For this task, factorise the raw ratings as supplied: do not mean-centre the ratings, add user or film bias terms, or add regularisation. These are useful extensions in a practical recommender system, but each would change the optimisation problem and the expected numerical result here.
